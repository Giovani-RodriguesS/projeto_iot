    ...
    <div className="flex min-h-screen bg-gray-100 dark:bg-slate-800 text-gray-900 dark:text-gray-100 overflow-hidden">
      <div className="flex-1">
        ...
        <main className="custom-tabview flex justify-center h-auto mt-8">
          <div className="card bg-gray-200 dark:bg-slate-700 p-6 rounded-lg shadow mt-0 text-3xl w-11/12">
            <TabView className="dark:text-gray-100">
              ...
              <TabPanel header="Turma ADS" leftIcon="pi pi-desktop">
                <p className="m-0 text-black gray-700 dark:text-gray-300 leading-relaxed text-justify text-2xl" style={{ textIndent: '3rem' }}>
