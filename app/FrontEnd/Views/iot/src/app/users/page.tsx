        ...
        <main className="w-full max-w-7xl mx-auto px-5 py-7">
          ...
          {users.map((user) => (
            <div key={user.id} className="p-4 bg-white rounded-xl w-48 flex flex-col items-center">
              <Image src="/images/profiles/user.jpg" width={80} height={80} className="mb-3 rounded-full" alt={user.nome}/>
          ...
          <div className="p-4 bg-gray-200 dark:bg-white rounded-xl w-48 flex flex-col items-center">
